...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\tools\install-live-test-package.ps1 -Edition Enhanced -Archive 'C:\Downloads\ReactorV-0.2.5-enhanced-live-test.zip' -GameRoot 'C:\Games\GTAV Enhanced'
```
