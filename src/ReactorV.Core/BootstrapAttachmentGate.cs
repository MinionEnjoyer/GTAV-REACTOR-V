...
namespace ReactorV.BootstrapHost
{
    ...
    public sealed class BootstrapAttachmentGate
    {
        ...
        /// <summary>
        /// Serializes the initial attachment only. A caller that has already
        /// attached supplies its health check; a lost established transport is
        /// reported false rather than creating a second reader/writer pair.
        /// </summary>
